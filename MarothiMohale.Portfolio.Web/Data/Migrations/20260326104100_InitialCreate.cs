        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excerpt = table.Column<string>(type: "TEXT", maxLength: 320, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Organization = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ResumeUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    HeroPrimaryCtaUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    HeroSecondaryCtaUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(type: "TEXT", maxLength: 320, nullable: false),
                    FullDescription = table.Column<string>(type: "TEXT", nullable: false),
                    TechStack = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    GitHubUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    LiveUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProficiencyPercent = table.Column<int>(type: "INTEGER", nullable: false),
                    Summary = table.Column<string>(type: "TEXT", nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorRole = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
